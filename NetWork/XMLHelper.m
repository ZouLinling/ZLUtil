...
-(NSString*)buildXml
{
    ...
    GDataXMLNode *attribute1 = [GDataXMLNode elementWithName:@"pageSize" stringValue:[XMLHelper int2String:_pageSize]];
    [sqlElement addAttribute:attribute1];
    GDataXMLNode *attribute2 = [GDataXMLNode elementWithName:@"pageIndex" stringValue:[XMLHelper int2String:_pageIndex]];
    [sqlElement addAttribute:attribute2];
    GDataXMLNode *attribute3 = [GDataXMLNode elementWithName:@"itemCount" stringValue:[XMLHelper int2String:_itemCount]];
